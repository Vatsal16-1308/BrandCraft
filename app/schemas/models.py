...
class ContentRequest(BaseModel):
    ...
    brand_description: str = Field(..., description="Brief brand description", min_length=2)
...
class SentimentRequest(BaseModel):
    ...
    text: str = Field(..., description="Text to analyze", min_length=2)
    context: str = Field(
